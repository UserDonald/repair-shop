...
VALUES
    ...
    (
        ...
        'Customer requested installation of new software.',
        false,
        'unassigned',
        now(),
        now()
    ...
    (
        ...
        'Customer is experiencing problems connecting to Wi-Fi.',
        false,
        'unassigned',
        now(),
        now()
    ...
    (
        ...
        'Customer needs to replace a failing hard drive.',
        false,
        'unassigned',
        now(),
        now()
    ...
    (
        4,
        'Battery replacement',
        'Customer needs a replacement for their laptop battery.',
        false,
        'unassigned',
        now(),
        now()
    ...
    (
        5,
        'Printer setup',
        'Customer needs help setting up a new printer.',
        false,
        'unassigned',
        now(),
        now()
    ...
    (
        5,
        'Memory upgrade',
        'Customer requested an upgrade to their computer’s RAM.',
        false,
        'unassigned',
        now(),
        now()
